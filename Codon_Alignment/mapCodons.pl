...
#Degenrate bases are not supported - this is handled by assuming the translation is correct
#Frameshift mutations will screw this up
#Some assholes like to guess the last AA in the translation - this will also cause screwups - currently trying to work on a fix, but manualchanges are best for now
#--------------------------------------------------------------------------------------#
